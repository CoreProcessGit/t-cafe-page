...
const TestCasesEn = () => (
  <article className="guide-article">
    ...
    <ul>
      <li><strong>Name</strong>: the TC title</li>
      <li><strong>Description</strong>: what the TC verifies</li>
      <li><strong>Precondition</strong>: the conditions that must be in place before the test runs</li>
      <li><strong>Test Steps</strong>: the steps to perform and the expected results</li>
      <li><strong>Priority</strong>: freely defined in Configuration → Priorities (default sample: Critical / High / Medium / Low)</li>
      <li><strong>Case Type</strong>: freely defined in Configuration → Case Type (default sample: Function / Performance / Regression / Security)</li>
      <li><strong>Components</strong>: freely defined in Configuration → Components (default sample: Frontend / Backend API / Database / Authentication / Payment); multi-select</li>
      <li><strong>Labels</strong>: free-form tags</li>
      <li><strong>Owner</strong>: the TC author</li>
    </ul>
    ...
    <h3>Navigation</h3>
    <p>Top tab → <strong>Test Cases</strong></p>

    <h3>Layout</h3>
    <ul>
      <li><strong>Left</strong>: folder tree (TCs grouped by folder; the left-panel width is adjustable)</li>
      <li><strong>Right</strong>: TC list (table format, showing TCs of the selected folder)</li>
    </ul>
    ...
    <ul>
      <li>Click the <strong>Key</strong> or <strong>Name</strong> of a TC in the list to navigate to the <strong>TC detail / edit page</strong></li>
      <li>The screen differs by TC type: <strong>Single TCs open the edit page</strong>, while <strong>Factor TCs open the Factor Combination detail page</strong></li>
      <li>When you return to the list, the previous scroll position and visible count are preserved</li>
    </ul>

    <h3>Columns</h3>
    <p>By default the following 10 columns are shown:</p>
    <ul>
    ...
    <ul>
      <li><strong>Search box</strong>: search by TC name, key, or description</li>
      <li><strong>Filters</strong>: filter by folder, priority, case type, component, label, or owner</li>
    </ul>
    ...
    <ol>
      ...
      <li>From the dropdown, choose <strong>Single</strong> or <strong>Factor Combination</strong></li>
      <li>The creation screen for the chosen type opens</li>
    </ol>
    <aside className="guide-callout info">
      This page (05) covers <strong>Single</strong> creation. Factor Combination creation is covered in <Link to="/support/guide/factor-combination">08. Factor Combination</Link>.
    </aside>
    ...
    <ol>
      <li><strong>Folder</strong> — the folder to place the TC in (defaults to the folder selected in the list)</li>
      <li><strong>Name</strong> (required) — the TC title</li>
      <li><strong>Description</strong> — describe what the TC verifies</li>
      <li><strong>Precondition</strong> — conditions that must be in place before the test runs</li>
    </ol>

    <h4>"Detail" Section (expand to fill)</h4>
    <ol>
      <li><strong>Priority</strong> — choose from the items defined in Configuration → Priorities</li>
      <li><strong>Case Type</strong> — choose from the items defined in Configuration → Case Types</li>
      <li><strong>Owner</strong> — choose an owner from the project members (dropdown)</li>
      <li><strong>Components</strong> — choose from the items defined in Configuration → Components</li>
      <li><strong>Labels</strong> — free-form (separate from Jira labels). Existing labels are suggested as auto-complete entries</li>
    </ol>
    ...
    <ul>
      ...
      <li>Fields marked as <strong>required (*)</strong> in Configuration must be filled in before saving</li>
    ...
    <h3>Saving</h3>
    <ul>
      <li><strong>Create</strong> button: a new TC is assigned a key (e.g., <code>PROJ-1</code>) automatically and saved</li>
      <li><strong>Cancel</strong>: cancels creation</li>
    </ul>
    ...
    <ol>
      ...
      <li>Click the <strong>Edit</strong> button on the right or at the bottom</li>
    ...
    <h3>Edit History</h3>
    <ul>
      <li>On edit, the <strong>updated_at</strong> is refreshed automatically and reflected in the "Updated" column</li>
    ...
    <ol>
      ...
      <li>Click <strong>Confirm</strong> in the confirmation dialog</li>
    </ol>
    ...
    <h3>Notes</h3>
    <ul>
      <li>Deleted TCs <strong>cannot be recovered</strong></li>
      <li>
        <strong>TCs already added to a TP (Test Plan) are kept as-is in the TP.</strong>
        When a TC is added to a TP, a snapshot (name, steps, precondition, etc.) is <strong>copied</strong> into the TP, so deleting the source TC does not affect the execution history or data inside the TP.
      </li>
    ...
    <p>T-CAFE <strong>securely protects</strong> sensitive test data (test steps, preconditions) when saving. No extra configuration is needed — it is handled automatically.</p>
