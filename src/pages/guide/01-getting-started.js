...
const GettingStarted = () => (
  <article className="guide-article">
    ...
    <ul>
      <li>환영 메시지: T-CAFE 소개</li>
      <li>샘플 데이터 생성 버튼: Admin 권한이 있는 경우에만 표시</li>
      <li>닫기 버튼 (×): 배너 숨기기</li>
    </ul>
    ...
    <p>처음 사용하시는 경우 샘플 데이터를 생성하여 T-CAFE의 기능을 빠르게 파악할 수 있습니다.</p>

    <h3>권한</h3>
    <ul>
      <li>Admin 전용 (Team Admin / Tester / Developer는 사용 불가)</li>
    </ul>

    <h3>생성되는 샘플 데이터</h3>
    <p>샘플 데이터를 생성하면 다음이 자동으로 만들어집니다:</p>
    <ul>
      <li>6개 폴더: Login, Dashboard, User Management, Payment, API Tests, Cross Browser</li>
      <li>약 10개의 Single Test Case (일부 Confirmed, 나머지 Draft — 실무 예시)</li>
      <li>20여 개의 Factor Combination Test Case ([Sample] Cross Browser 폴더 — Browser/Device/OS/Feature 조합, Two-Way Exclude 제약 예시 포함)</li>
      <li>2개의 Test Plan (Sprint 1 통합 테스트, Sprint 2 회귀 테스트 — Confirmed TC 로 구성)</li>
      <li>2개의 게시판 게시글 (공지 + 일반)</li>
      <li>
        기본 샘플 Configuration (Configuration에서 자유롭게 추가/수정/삭제 가능):
    ...
    <h3>생성 절차</h3>
    <ol>
      <li>Overview 페이지의 Welcome Banner에서 "샘플 데이터 생성" 버튼 클릭</li>
      <li>생성 진행 (약 30초)</li>
    ...
    <h3>주의 사항</h3>
    <ul>
      <li>샘플 데이터는 프로젝트당 1회만 생성 가능합니다</li>
    ...
    <h3>프로젝트 선택</h3>
    <ul>
      <li>T-CAFE는 프로젝트별로 데이터가 격리됩니다</li>
    ...
    <ul>
      ...
      <li>언어 설정은 사용자별 + 프로젝트별로 저장됩니다</li>
    </ul>
    ...
    <ol>
      <li>샘플 데이터 생성 (위 2번)</li>
      <li>사용자 권한 설정 (<Link to="/support/guide/permissions">02. 사용자 권한</Link>)</li>
      <li>테스트 케이스 살펴보기 (<Link to="/support/guide/test-cases">05. 테스트 케이스 기본 사용법</Link>)</li>
      <li>테스트 플랜 살펴보기 (<Link to="/support/guide/test-plans">10. 테스트 플랜 관리</Link>)</li>
      <li>실제 테스트 케이스 작성하기</li>
    </ol>
...
const GettingStartedEn = () => (
  <article className="guide-article">
    ...
    <ul>
      <li>Welcome message: T-CAFE introduction</li>
      <li>Create Sample Data button: shown only to users with the Admin role</li>
      <li>Close button (×): hides the banner</li>
    </ul>
    ...
    <p>If you are a first-time user, generate sample data to quickly explore T-CAFE's features.</p>

    <h3>Permission</h3>
    <ul>
      <li>Admin only (not available for Team Admin / Tester / Developer)</li>
    </ul>

    <h3>Sample Data Created</h3>
    <p>When you generate sample data, the following are created automatically:</p>
    <ul>
      <li>6 folders: Login, Dashboard, User Management, Payment, API Tests, Cross Browser</li>
      <li>About 10 Single Test Cases (some Confirmed, others Draft — realistic mix)</li>
      <li>About 20 Factor Combination Test Cases ([Sample] Cross Browser folder — Browser/Device/OS/Feature combinations with a Two-Way Exclude constraint example)</li>
      <li>2 Test Plans (Sprint 1 Integration Test, Sprint 2 Regression Test — composed of Confirmed TCs)</li>
      <li>2 board posts (Notice + General)</li>
      <li>
        Default sample Configuration (freely add/edit/delete in Configuration):
        Priority (Critical/High/Medium/Low), Case Type (Function/Performance/Regression/Security),
        Component (Frontend/Backend API/Database/Authentication/Payment), Plan Status (Prepairing/Open/Completed)
      </li>
    </ul>
    ...
    <ol>
      <li>On the Overview page Welcome Banner, click the "Create Sample Data" button</li>
    ...
    <h3>Notes</h3>
    <ul>
      <li>Sample data can be generated only once per project</li>
    ...
    <ul>
      <li>T-CAFE isolates data per project</li>
    ...
    <ul>
      ...
      <li>Language settings are saved per user + per project</li>
    </ul>
    ...
    <ol>
      <li>Create sample data (section 2 above)</li>
      <li>Configure user permissions (<Link to="/support/guide/permissions">02. User Permissions</Link>)</li>
      <li>Explore Test Cases (<Link to="/support/guide/test-cases">05. Test Case Basics</Link>)</li>
      <li>Explore Test Plans (<Link to="/support/guide/test-plans">10. Test Plan Management</Link>)</li>
